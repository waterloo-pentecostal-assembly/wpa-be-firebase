...
1. Clone repository.
2. `cd` into `wpa-be-firebase/function-v2`.
...
3. Rename the downloaded JSON to `service-account-dev.json` and move it to `wpa-be-firebase/function-v2/src/config`.
4. Copy the `firebaseConfig` from [here](https://console.firebase.google.com/u/0/project/wpa-be-app-dev/settings/general/web:NGJmODYyMTctODE2Yy00ZmE4LTliODAtZDc3Zjg2ODAyYzY2) and put it in a new file `wpa-be-firebase/function-v2/src/config/client-config-dev.json`. Reformat to proper json. 
